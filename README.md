...
- 文本框统一使用固定在可视区底部、软键盘上方的临时编辑面板；输入实时回显到原画布，选中文本后可用颜色槽改色并通过选区锚点缩放。图形支持直线/驻留折线、矩形、椭圆、光滑曲线及直线/直角/曲线连接器，可直接拖动、锁定、编组、调整层级、对齐或分布。
...
PDF 标注视图工具栏中的下载按钮提供“合成 PDF”和“导出图层包 ZIP”。
合成 PDF 只合并当前可见图层并保留原 PDF 页面；ZIP 包含原文件、全部
